...
public class AboutFragment extends Fragment {
    ...
    CardViewNative[] cvn;
    View rootView;
    String[] name = {"Weather","Open Weather Map" , "Weather Icons" , "Material Drawer" , "Material Dialogs" , "SystemBarTint" , "AndroidIconics" , "MPAndroidChart" , "Material Icons" , "Bottom Bar" , "CardsLib"};
    ...
    String[] description = {"This is the weather app I've built as a part of the assignment of the Android Internship Workshop I'd attended at Amrita in the Summer of 2016","All the Weather Data You See in this app is due to the data being provided by Open Weather Map. You must be thanking them first" ,
